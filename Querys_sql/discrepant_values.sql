--- Unificar variables STRING, como que todas queden en mayusculas, minusculas, que no haya una palabra que quede desogranizada
--- Se verifico la categoria de prestamos.
WITH clean_table AS (
  SELECT
    user_id,
    CASE
